...
Giving all these different tracking capabilities of headset, from a software frameworks point of view VR systems are usually split into room-scale experiences where all tracking is available, seating or standing experiences with no translational tracking and lastly experiences with no translational tracking and interaction like watching a 3D video. 
