...
Therefore, enabling us to set the render order of the instanced buffers ascending according to the hierarchical layers. A correct render order ensures  a valid transparency so that child nodes can be seen from the outside.
