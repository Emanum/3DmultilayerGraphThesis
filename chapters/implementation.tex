...
The visualization expects a combined JSON file with all nodes and links with their assigned layer as seen in Section \ref{subSec:dataStruct}.
...
While transforming the data structure, all node IDs are extended with their hierarchical layer information to make them unique for the entire dataset.  
