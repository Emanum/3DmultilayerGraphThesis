...
For evaluation, we measured performance and technical limits of our solution in Section \ref{sec:performanceEvaluation}. In addition, we gathered usability feedback in the form of an interview and a heuristic evaluation in Section \ref{sec:heuristicEvaluation}. As a side note, due to the COVID-19 pandemic during the writing we were mostly restricted to online feedback.\\
