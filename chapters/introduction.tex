...
\begin{figure}[h]
    ...
    \caption{Screenshot of our prototype network visualization with the comorbidity network dataset from \ref{fig:original2DdiseaseNet}. In the screenshot only edges from node 0.3 are displayed.} % Remove the [...] argument if the original caption should be used in the figure list.
