...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.5\columnwidth}
      ...
      \subcaption{A Comorbidity network of diagnoses related to diabetes melitus \cite{sorger_immersive_2019}. The boxes represent the first hierarchical layer and spheres the second layer.}
    ...
    \begin{subfigure}[b]{0.7\columnwidth}
      ...
      \subcaption{A part of a generated node-link graph with about 1000 nodes and 2000 links on 4 hierarchical layers. The color of the nodes represents their hierarchical parent node.}
